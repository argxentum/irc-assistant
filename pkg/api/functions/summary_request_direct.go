...
func (f *summaryFunction) directRequest(e *irc.Event, url string) (*summary, error) {
	return f.request(e, url, false)
}

func (f *summaryFunction) request(e *irc.Event, url string, impersonated bool) (*summary, error) {
	logger := log.Logger()
